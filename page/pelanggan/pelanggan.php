...
<div class="form-group">
                          ...
                          <input type="text" name="nama_agen" class="form-control" value="<?php echo $data1['nama_agen']; ?>" required="">      
                        </div>
              ...
              if (isset($_POST['simpan'])) {
                ...
                $nama_agen = htmlspecialchars(strip_tags($_POST['nama_agen']));
...
<?php 
      ...
      if (isset($_POST['tambah'])) {
        ...
        $sql = $koneksi->query("insert into tb_pelanggan (nama_pelanggan, alamat, no_telp, paket, nama_agen)values('$nama', '$alamat', '$no_telp', '$paket', '$nama_agen') ");

        $id_pelanggan = $koneksi->insert_id;

        $sql = $koneksi->query("insert into tb_user (username, nama_user, password, level, foto, id_pelanggan)values('$nama', '$nama', 'user', 'user', 'admin.png', '$id_pelanggan') ");
