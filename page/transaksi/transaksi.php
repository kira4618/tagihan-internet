               ...
               <a href="?page=transaksi&aksi=tambah" class="btn btn-default" style="margin-top: 45px;"  title=""><i class="fa fa-plus"></i> Tambah Tagihan</a>
                ...
                <tr>
                  ...
                  <td> 
                    ...
                    <a  href="https://api.whatsapp.com/send?phone=<?php echo $no_hp ?>&text=Kepada Pelanggan Hosting Jagodigital Bapak/Ibu: <?php echo $data['nama_pelanggan']?>, alamat: <?php echo $data['alamat']?>,  Paket: <?php echo  $data['nama_paket']?>,  Total Tagihan:  Rp <?php echo number_format($data['jml_bayar'])?>,  Pembayaran mulai tanggal 1-10 tiap bulanya,  terima kasih" target="blank" class="btn btn-success btn-xs"> <i class="fa  fa-whatsapp"></i> Kirim WA</a>
